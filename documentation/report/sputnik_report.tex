...
Overall reactions to Sputnik were generally positive.
...
The results of the Likert items were inconclusive with the \emph{strongly disagree/neutral/agree} answer triplet given in the first question, and \emph{disagree/neutral/agree} given in all others.
...
- participants found out functions
- spatial arrangement of objects prior to performance
- artificial distance limit
- controller waggle
- participants seemed to have not troubles using the arc
- responsiveness --> Filtering
